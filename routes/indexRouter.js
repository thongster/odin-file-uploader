...
indexRouter.get('/folders', indexController.showIndex);
...
indexRouter.post('/:fileId/delete', indexController.deleteFile);
indexRouter.post('/folders/:folder/:fileId/delete', indexController.deleteFile);
